...
export const encryptLocalStorage = (data, storage_name, secret = "appReact") => {
...
export const hash = "b75524255a7f54d2726a951bb39204df";

export const decryptLocalStorage = (storage_name, secret = "appReact") => {
